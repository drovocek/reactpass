package ru.volkov.getpass.util;

import lombok.NoArgsConstructor;
import ru.volkov.getpass.data.AbstractEntity;
import ru.volkov.getpass.util.exception.IllegalRequestDataException;
...
public class ValidationUtil {
    ...
    public static void assureIdConsistent(AbstractEntity bean, int id) {
        if (bean.isNew()) {
            bean.setId(id);
        } else if (bean.id() != id) {
